...
[[ -z "$bzimage" ]] && bzimage="/root/image/bzImage_5.13-rc7i"

qemu-system-x86_64 \
        -m 2G \
        -smp 2 \
        -kernel $bzimage \
        -append "console=ttyS0 root=/dev/sda3 earlyprintk=serial net.ifnames=0" \
        -drive file=./ubuntu20.10_mini.img,format=raw \
